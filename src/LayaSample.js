...
(function () {
    ...
    function onMouseUp(e) {
        ...
        if(allBodies[1].constraints[0].pointA.x<730){
            allBodies[1].constraints[0].pointA.x = allBodies[1].constraints[0].pointA.x + Math.random()*50;
            console.log(allBodies[1].constraints[0].pointA.x )
        }
    ...
    function initworld() {
        ...
        Matter.Events.on(engine, 'afterUpdate', function (event) {
            ...
            if (ragdoll2.bodies[6].bounds.min.y > 521) {
                ...
                allBoies[1].constraints[0].stiffness = 0.1;
